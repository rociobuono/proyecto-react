    ...
    return (
        <section className="bg-white dark:bg-gray-900">
            <div className="container px-6 py-10 mx-auto">
                <h1 className="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">Nuestro Equipo</h1>

                <p className="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">
                    Somos un grupo de entusiastas de la cocina comprometidos a compartir recetas que inspiran y deleitan. Fusionamos tradición y creatividad, ofreciendo platos accesibles para todos. Únete a nosotros en este delicioso viaje y descubre la magia de cocinar en casa.
                </p>

                <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
                    <div className="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-stone-500 dark:border-gray-700 dark:hover:border-transparent">
                        ...
                        <p className="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Cocinero local</p>
                    ...
                    <div className="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-stone-500 dark:border-gray-700 dark:hover:border-transparent">
                        ...
                        <p className="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Nutricionista</p>
                    ...
                    <div className="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-stone-500 dark:border-gray-700 dark:hover:border-transparent">
                        ...
                        <p className="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Chef Ejecutiva</p>
                    ...
                    <div className="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-stone-500 dark:border-gray-700 dark:hover:border-transparent">
                        ...
                        <p className="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Cocinero Pastelero</p>
